...
func (ma *_FinishedTask__Assembler) valueFinishTidy() bool {
	...
	case 15:
		...
		case schema.Maybe_Null:
			...
			return true
		case schema.Maybe_Value:
			ma.w.PayloadCID.v = ma.ca_PayloadCID.w
			ma.state = maState_initial
			return true
		default:
			return false
	...
	case 16:
		...
		case schema.Maybe_Null:
			...
			return true
		case schema.Maybe_Value:
			ma.w.ProposalCID.v = ma.ca_ProposalCID.w
			ma.state = maState_initial
			return true
		default:
			return false
...
func (ma *_FinishedTask__Assembler) AssembleEntry(k string) (ipld.NodeAssembler, error) {
	...
	case "MinerVersion":
		if ma.s & fieldBit__FinishedTask_MinerVersion != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_MinerVersion}
		}
	...
	case "Size":
		if ma.s & fieldBit__FinishedTask_Size != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_Size}
		}
	...
	case "PayloadCID":
		if ma.s & fieldBit__FinishedTask_PayloadCID != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_PayloadCID}
		}
	...
	case "ProposalCID":
		if ma.s & fieldBit__FinishedTask_ProposalCID != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_ProposalCID}
		}
...
func (ka *_FinishedTask__KeyAssembler) AssignString(k string) error {
	...
	case "MinerVersion":
		if ka.s & fieldBit__FinishedTask_MinerVersion != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_MinerVersion}
		}
	...
	case "Size":
		if ka.s & fieldBit__FinishedTask_Size != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_Size}
		}
	...
	case "PayloadCID":
		if ka.s & fieldBit__FinishedTask_PayloadCID != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_PayloadCID}
		}
	...
	case "ProposalCID":
		if ka.s & fieldBit__FinishedTask_ProposalCID != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_ProposalCID}
		}
...
func (ma *_FinishedTask__ReprAssembler) AssembleEntry(k string) (ipld.NodeAssembler, error) {
	...
	case "MinerVersion":
		if ma.s & fieldBit__FinishedTask_MinerVersion != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_MinerVersion_serial}
		}
		ma.s += fieldBit__FinishedTask_MinerVersion
		ma.state = maState_midValue
		ma.f = 12
	...
	case "Size":
		if ma.s & fieldBit__FinishedTask_Size != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_Size_serial}
		}
		ma.s += fieldBit__FinishedTask_Size
		ma.state = maState_midValue
		ma.f = 14
	...
	case "PayloadCID":
		if ma.s & fieldBit__FinishedTask_PayloadCID != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_PayloadCID_serial}
		}
		ma.s += fieldBit__FinishedTask_PayloadCID
		ma.state = maState_midValue
		ma.f = 15
	...
	case "ProposalCID":
		if ma.s & fieldBit__FinishedTask_ProposalCID != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_ProposalCID_serial}
		}
		ma.s += fieldBit__FinishedTask_ProposalCID
		ma.state = maState_midValue
		ma.f = 16
...
func (ka *_FinishedTask__ReprKeyAssembler) AssignString(k string) error {
	...
	case "MinerVersion":
		if ka.s & fieldBit__FinishedTask_MinerVersion != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_MinerVersion_serial}
		}
		ka.s += fieldBit__FinishedTask_MinerVersion
		ka.state = maState_expectValue
		ka.f = 12
	...
	case "Size":
		if ka.s & fieldBit__FinishedTask_Size != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_Size_serial}
		}
		ka.s += fieldBit__FinishedTask_Size
		ka.state = maState_expectValue
		ka.f = 14
	case "PayloadCID":
		if ka.s & fieldBit__FinishedTask_PayloadCID != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_PayloadCID_serial}
		}
		ka.s += fieldBit__FinishedTask_PayloadCID
		ka.state = maState_expectValue
		ka.f = 15
	case "ProposalCID":
		if ka.s & fieldBit__FinishedTask_ProposalCID != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__FinishedTask_ProposalCID_serial}
		}
		ka.s += fieldBit__FinishedTask_ProposalCID
		ka.state = maState_expectValue
		ka.f = 16
...
func (ma *_PopTask__Assembler) AssembleEntry(k string) (ipld.NodeAssembler, error) {
	...
	case "Tags":
		if ma.s & fieldBit__PopTask_Tags != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__PopTask_Tags}
		}
...
func (ka *_PopTask__KeyAssembler) AssignString(k string) error {
	...
	case "Tags":
		if ka.s & fieldBit__PopTask_Tags != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__PopTask_Tags}
		}
...
func (ma *_PopTask__ReprAssembler) AssembleEntry(k string) (ipld.NodeAssembler, error) {
	...
	case "Tags":
		if ma.s & fieldBit__PopTask_Tags != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__PopTask_Tags_serial}
		}
		ma.s += fieldBit__PopTask_Tags
		ma.state = maState_midValue
		ma.f = 2
...
func (ka *_PopTask__ReprKeyAssembler) AssignString(k string) error {
	...
	case "Tags":
		if ka.s & fieldBit__PopTask_Tags != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__PopTask_Tags_serial}
		}
		ka.s += fieldBit__PopTask_Tags
		ka.state = maState_expectValue
		ka.f = 2
...
func (ma *_RetrievalTask__Assembler) valueFinishTidy() bool {
	...
	case 6:
		...
		case schema.Maybe_Null:
			...
			return true
		case schema.Maybe_Value:
			ma.w.MaxPriceAttoFIL.v = ma.ca_MaxPriceAttoFIL.w
			ma.state = maState_initial
			return true
		default:
			return false
...
func (ma *_RetrievalTask__Assembler) AssembleEntry(k string) (ipld.NodeAssembler, error) {
	...
	case "Tag":
		if ma.s & fieldBit__RetrievalTask_Tag != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__RetrievalTask_Tag}
		}
	...
	case "MaxPriceAttoFIL":
		if ma.s & fieldBit__RetrievalTask_MaxPriceAttoFIL != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__RetrievalTask_MaxPriceAttoFIL}
		}
...
func (ka *_RetrievalTask__KeyAssembler) AssignString(k string) error {
	...
	case "Tag":
		if ka.s & fieldBit__RetrievalTask_Tag != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__RetrievalTask_Tag}
		}
	...
	case "MaxPriceAttoFIL":
		if ka.s & fieldBit__RetrievalTask_MaxPriceAttoFIL != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__RetrievalTask_MaxPriceAttoFIL}
		}
...
func (ma *_RetrievalTask__ReprAssembler) AssembleEntry(k string) (ipld.NodeAssembler, error) {
	...
	case "Tag":
		if ma.s & fieldBit__RetrievalTask_Tag != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__RetrievalTask_Tag_serial}
		}
		ma.s += fieldBit__RetrievalTask_Tag
		ma.state = maState_midValue
		ma.f = 5
	...
	case "MaxPriceAttoFIL":
		if ma.s & fieldBit__RetrievalTask_MaxPriceAttoFIL != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__RetrievalTask_MaxPriceAttoFIL_serial}
		}
		ma.s += fieldBit__RetrievalTask_MaxPriceAttoFIL
		ma.state = maState_midValue
		ma.f = 6
...
func (ka *_RetrievalTask__ReprKeyAssembler) AssignString(k string) error {
	...
	case "Tag":
		if ka.s & fieldBit__RetrievalTask_Tag != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__RetrievalTask_Tag_serial}
		}
		ka.s += fieldBit__RetrievalTask_Tag
		ka.state = maState_expectValue
		ka.f = 5
	case "MaxPriceAttoFIL":
		if ka.s & fieldBit__RetrievalTask_MaxPriceAttoFIL != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__RetrievalTask_MaxPriceAttoFIL_serial}
		}
		ka.s += fieldBit__RetrievalTask_MaxPriceAttoFIL
		ka.state = maState_expectValue
		ka.f = 6
...
func (ma *_StorageTask__Assembler) valueFinishTidy() bool {
	...
	case 9:
		...
		case schema.Maybe_Null:
			...
			return true
		case schema.Maybe_Value:
			ma.w.RetrievalSchedule.v = ma.ca_RetrievalSchedule.w
			ma.state = maState_initial
			return true
		default:
			return false
	...
	case 10:
		...
		case schema.Maybe_Null:
			...
			return true
		case schema.Maybe_Value:
			ma.w.RetrievalScheduleLimit.v = ma.ca_RetrievalScheduleLimit.w
			ma.state = maState_initial
			return true
		default:
			return false
...
func (ma *_StorageTask__Assembler) AssembleEntry(k string) (ipld.NodeAssembler, error) {
	...
	case "Tag":
		if ma.s & fieldBit__StorageTask_Tag != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__StorageTask_Tag}
		}
	...
	case "RetrievalSchedule":
		if ma.s & fieldBit__StorageTask_RetrievalSchedule != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__StorageTask_RetrievalSchedule}
		}
	...
	case "RetrievalScheduleLimit":
		if ma.s & fieldBit__StorageTask_RetrievalScheduleLimit != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__StorageTask_RetrievalScheduleLimit}
		}
...
func (ka *_StorageTask__KeyAssembler) AssignString(k string) error {
	...
	case "Tag":
		if ka.s & fieldBit__StorageTask_Tag != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__StorageTask_Tag}
		}
	...
	case "RetrievalSchedule":
		if ka.s & fieldBit__StorageTask_RetrievalSchedule != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__StorageTask_RetrievalSchedule}
		}
	...
	case "RetrievalScheduleLimit":
		if ka.s & fieldBit__StorageTask_RetrievalScheduleLimit != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__StorageTask_RetrievalScheduleLimit}
		}
...
func (ma *_StorageTask__ReprAssembler) AssembleEntry(k string) (ipld.NodeAssembler, error) {
	...
	case "Tag":
		if ma.s & fieldBit__StorageTask_Tag != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__StorageTask_Tag_serial}
		}
		ma.s += fieldBit__StorageTask_Tag
		ma.state = maState_midValue
		ma.f = 8
	...
	case "RetrievalSchedule":
		if ma.s & fieldBit__StorageTask_RetrievalSchedule != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__StorageTask_RetrievalSchedule_serial}
		}
		ma.s += fieldBit__StorageTask_RetrievalSchedule
		ma.state = maState_midValue
		ma.f = 9
	...
	case "RetrievalScheduleLimit":
		if ma.s & fieldBit__StorageTask_RetrievalScheduleLimit != 0 {
			return nil, ipld.ErrRepeatedMapKey{&fieldName__StorageTask_RetrievalScheduleLimit_serial}
		}
		ma.s += fieldBit__StorageTask_RetrievalScheduleLimit
		ma.state = maState_midValue
		ma.f = 10
...
func (ka *_StorageTask__ReprKeyAssembler) AssignString(k string) error {
	...
	case "Tag":
		if ka.s & fieldBit__StorageTask_Tag != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__StorageTask_Tag_serial}
		}
		ka.s += fieldBit__StorageTask_Tag
		ka.state = maState_expectValue
		ka.f = 8
	case "RetrievalSchedule":
		if ka.s & fieldBit__StorageTask_RetrievalSchedule != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__StorageTask_RetrievalSchedule_serial}
		}
		ka.s += fieldBit__StorageTask_RetrievalSchedule
		ka.state = maState_expectValue
		ka.f = 9
	case "RetrievalScheduleLimit":
		if ka.s & fieldBit__StorageTask_RetrievalScheduleLimit != 0 {
			return ipld.ErrRepeatedMapKey{&fieldName__StorageTask_RetrievalScheduleLimit_serial}
		}
		ka.s += fieldBit__StorageTask_RetrievalScheduleLimit
		ka.state = maState_expectValue
		ka.f = 10
